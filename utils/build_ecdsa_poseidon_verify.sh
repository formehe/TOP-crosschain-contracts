CIRCUITS_DIR=../circoms
PHASE1=./pot20_final.ptau
BUILD_DIR=../build/EdDSAPoseidonVerifier
CIRCUIT_NAME=EdDsaPoseidonVerifier
...
start=`date +%s`
NODE_OPTIONS="--max-old-space-size=4096" npx snarkjs zkey beacon "$BUILD_DIR"/"$CIRCUIT_NAME"_0.zkey "$BUILD_DIR"/"$CIRCUIT_NAME".zkey 12FE2EC467BD428DD0E966A6287DE2AF8DE09C2C5C0AD902B2C666B0895ABB75 10 -n="Final Beacon phase2"
end=`date +%s`
echo "DONE ($((end-start))s)"
