 ...
 */
abstract contract TimestampGovernorCompatibilityBravo is IGovernorTimelock, IGovernorCompatibilityBravo, TimestampGovernor {
    ...
    ) public virtual override(IGovernor, TimestampGovernor) returns (uint256) {
