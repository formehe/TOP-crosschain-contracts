...
library BabyJubJub {
    ...
    function modinv(uint256 a, uint256 q) internal pure returns (uint256) {
    ...
    function addition(
        uint256[2] memory p,
        uint256[2] memory q
    ) public pure returns (uint256[2] memory r) {
    ...
    function scalarmul(uint256 n, uint256[2] memory p) public pure returns (uint256[2] memory r) {
        r[0] = 0;
        r[1] = 1;
