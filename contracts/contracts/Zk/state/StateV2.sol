...
contract StateV2 is OwnableUpgradeable, IState {
    /**
     ...
     */
    function getStateInfoById(uint256 id) external view override returns (IState.StateInfo memory) {
    ...
    function getStateInfoByIdAndState(
        uint256 id,
        uint256 state
    ) external view override returns (IState.StateInfo memory) {
     ...
     */
    function getGISTRootInfo(uint256 root) external view override returns (IState.GistRootInfo memory) {
